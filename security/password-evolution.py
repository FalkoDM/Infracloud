...
# Flask code to configure the server to store a username and password in plain text
##################Plain Text##################
...
# Flask code to verify account credentials
...
# Flask code that is used during each login attempt to read the parameters from a HTTP request
# verify's the account and returns the proper message
